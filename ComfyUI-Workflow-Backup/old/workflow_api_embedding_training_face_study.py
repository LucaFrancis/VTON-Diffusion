...
def main():
    ...
    with torch.inference_mode():
        ...
        for root, _, files in os.walk(
            ...
            for f in files:
                if f.lower().startswith(embedding_name + '-'):
                    jpg_paths.append(f)
        print("found", len(jpg_paths), "embedding training points")

        image_path = "/datasets/deep-fashion/In-shop Clothes Retrieval Benchmark/Img/img_highres/MEN/Jackets_Vests/id_00000094/01_1_front.jpg"
        ...
        seargeimagesave.save_images(
            filename_prefix="face_study/" + run + "/mask",
        ...
        for path in jpg_paths:
            ...
            print("Saving image for ", path)
            seargeimagesave.save_images(
                filename_prefix="face_study/" + run + "/" + path,
