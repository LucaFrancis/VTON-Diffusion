...
def main():
    ...
    with torch.inference_mode():
        ...
        for root, _, files in os.walk(
                "/home/luca/virtual-tryon-diffusion/datasets/deep-fashion-test/img/img_highres/MEN"):
            for f in files:
        ...
        for path in jpg_paths:
            seargeinput1_270[0]["image"] = path
            seargeinput1_270[0]["mask"] = path.split(".")[0] + "_mask.png"
            seargeparameterprocessor_131 = seargeparameterprocessor.process(
